...
on a 0.6B RM show that demographic biases are large and behaviourally removable from the reward scalar, yet
the underlying concept remains \emph{non-linearly recoverable after optimal linear erasure}: null-space
projection fixes the reward, not the representation. On essay grading the reliability-harm metric becomes
