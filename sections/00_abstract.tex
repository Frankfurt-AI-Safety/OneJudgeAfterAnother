...
interpretable \outdated{withdrawn: that reading came from the direct form, retired 2026-09-24 (length-confounded); the
harm evidence now comes from a cross-marker decision design, not yet run at scale}, and a novel
\emph{standpoint-credibility} effect emerges, in which the RM rewards an identical
