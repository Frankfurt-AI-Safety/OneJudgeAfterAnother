...
\nEvalBattery{} held-out matched pairs per battery cell, \crossNCredit{} (credit) / \crossNCV{} (CV) /
\crossNEduPersuade{} (essays) pairs for \crossinf{}, and \nEvalStandpointPersuade{} (PERSUADE) /
\nEvalStandpointAsap{} (ASAP) essays for the standpoint arm. Robustness is assessed across encoding, template,
and injection position, under a scalar matched-pair readout.
